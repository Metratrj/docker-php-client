...
```php
<?php
require_once('/path/to/GeneratedDocker/vendor/autoload.php');
```
...
- [ClusterVolumeSpecAccessModeCapacityRange](docs/Model/ClusterVolumeSpecAccessModeCapacityRange.md)
