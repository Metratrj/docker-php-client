...
```php
containerStats($id, $stream, $one_shot): \OpenAPI\Client\Model\ContainerStatsResponse
```
...
[**\OpenAPI\Client\Model\ContainerStatsResponse**](../Model/ContainerStatsResponse.md)
