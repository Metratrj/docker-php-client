...
class ContainerApi
{
     ...
     * @param  bool|null $logs Replay previous logs from the container.  This is useful for attaching to a container that has started and you want to output everything since the container started.  If &#x60;stream&#x60; is also enabled, once all the previous output has been returned, it will seamlessly transition into streaming current output. (optional, default to false)
     * @param  bool|null $stream Stream attached streams from the time the request was made onwards. (optional, default to false)
     * @param  bool|null $stdin Attach to &#x60;stdin&#x60; (optional, default to false)
     * @param  bool|null $stdout Attach to &#x60;stdout&#x60; (optional, default to false)
     ...
     * @param  string $id ID or name of the container (required)
     * @param  string|null $detach_keys Override the key sequence for detaching a container.Format is a single character &#x60;[a-Z]&#x60; or &#x60;ctrl-&lt;value&gt;&#x60; where &#x60;&lt;value&gt;&#x60; is one of: &#x60;a-z&#x60;, &#x60;@&#x60;, &#x60;^&#x60;, &#x60;[&#x60;, &#x60;,&#x60;, or &#x60;_&#x60;. (optional)
     * @param  bool|null $logs Return logs (optional, default to false)
     * @param  bool|null $stream Return stream (optional, default to false)
     * @param  bool|null $stdin Attach to &#x60;stdin&#x60; (optional, default to false)
     * @param  bool|null $stdout Attach to &#x60;stdout&#x60; (optional, default to false)
     * @param  bool|null $stderr Attach to &#x60;stderr&#x60; (optional, default to false)
     ...
     *
     * @param  string $id ID or name of the container (required)
     * @param  bool|null $v Remove anonymous volumes associated with the container. (optional, default to false)
     * @param  bool|null $force If the container is running, kill it before removing it. (optional, default to false)
     ...
     * List containers
     *
     * @param  bool|null $all Return all containers. By default, only running containers are shown. (optional, default to false)
     * @param  int|null $limit Return this number of most recently created containers, including non-running ones. (optional)
     * @param  bool|null $size Return the size of container as fields &#x60;SizeRw&#x60; and &#x60;SizeRootFs&#x60;. (optional, default to false)
     ...
     *
     * @param  string $id ID or name of the container (required)
     * @param  bool|null $follow Keep connection after returning logs. (optional, default to false)
     * @param  bool|null $stdout Return logs from &#x60;stdout&#x60; (optional, default to false)
     * @param  bool|null $stderr Return logs from &#x60;stderr&#x60; (optional, default to false)
     * @param  int|null $since Only return logs since this time, as a UNIX timestamp (optional, default to 0)
     * @param  int|null $until Only return logs before this time, as a UNIX timestamp (optional, default to 0)
     * @param  bool|null $timestamps Add timestamps to every log line (optional, default to false)
     ...
     *
     * @param  string $id ID or name of the container (required)
     * @param  int $h Height of the TTY session in characters (required)
     ...
     *
     * @param  string $id ID or name of the container (required)
     * @param  string|null $signal Signal to send to the container as an integer or string (e.g. &#x60;SIGINT&#x60;). (optional)
     ...
     *
     * @param  string $id ID or name of the container (required)
     * @param  bool|null $stream Stream the output. If false, the stats will be output once and then it will disconnect. (optional, default to true)
    ...
    public function containerStatsWithHttpInfo($id, $stream = true, $one_shot = false, string $contentType = self::contentTypes['containerStats'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\ContainerStatsResponse',
                        $request,
                        $response,
                    );
                case 404:
    ...
    {
        $returnType = '\OpenAPI\Client\Model\ContainerStatsResponse';
        $request = $this->containerStatsRequest($id, $stream, $one_shot, $contentType);
