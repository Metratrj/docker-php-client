...
class ImageApi
{
     ...
     *
     * @param  int|null $keep_storage Amount of disk space in bytes to keep for cache  &gt; **Deprecated**: This parameter is deprecated and has been renamed to \&quot;reserved-space\&quot;. &gt; It is kept for backward compatibility and will be removed in API v1.49. (optional)
     * @param  int|null $reserved_space Amount of disk space in bytes to keep for cache (optional)
     * @param  int|null $max_used_space Maximum amount of disk space allowed to keep for cache (optional)
     * @param  int|null $min_free_space Target amount of free disk space after pruning (optional)
     * @param  bool|null $all Remove all types of build cache (optional)
    ...
    {
        list($response) = $this->buildPruneWithHttpInfo($keep_storage, $reserved_space, $max_used_space, $min_free_space, $all, $filters, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->buildPruneRequest($keep_storage, $reserved_space, $max_used_space, $min_free_space, $all, $filters, $contentType);
    ...
    {
        return $this->buildPruneAsyncWithHttpInfo($keep_storage, $reserved_space, $max_used_space, $min_free_space, $all, $filters, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    public function buildPruneRequest($keep_storage = null, $reserved_space = null, $max_used_space = null, $min_free_space = null, $all = null, $filters = null, string $contentType = self::contentTypes['buildPrune'][0])
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $reserved_space,
            'reserved-space', // param base name
            'integer', // openApiType
            '', // style
            false, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $max_used_space,
            'max-used-space', // param base name
            'integer', // openApiType
            '', // style
            false, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $min_free_space,
            'min-free-space', // param base name
            'integer', // openApiType
            '', // style
            false, // explode
            false // required
     ...
     * Build an image
     *
     * @param  string|null $dockerfile Path within the build context to the &#x60;Dockerfile&#x60;. This is ignored if &#x60;remote&#x60; is specified and points to an external &#x60;Dockerfile&#x60;. (optional, default to 'Dockerfile')
     * @param  string|null $t A name and optional tag to apply to the image in the &#x60;name:tag&#x60; format. If you omit the tag the default &#x60;latest&#x60; value is assumed. You can provide several &#x60;t&#x60; parameters. (optional)
     * @param  string|null $extrahosts Extra hosts to add to /etc/hosts (optional)
     * @param  string|null $remote A Git repository URI or HTTP/HTTPS context URI. If the URI points to a single text file, the file’s contents are placed into a file called &#x60;Dockerfile&#x60; and the image is built from that file. If the URI points to a tarball, the file is downloaded by the daemon and the contents therein used as the context for the build. If the URI points to a tarball and the &#x60;dockerfile&#x60; parameter is also specified, there must be a file with the corresponding path inside the tarball. (optional)
     * @param  bool|null $q Suppress verbose build output. (optional, default to false)
     * @param  bool|null $nocache Do not use the cache when building the image. (optional, default to false)
     * @param  string|null $cachefrom JSON array of images used for build cache resolution. (optional)
     * @param  string|null $pull Attempt to pull the image even if an older image exists locally. (optional)
     * @param  bool|null $rm Remove intermediate containers after a successful build. (optional, default to true)
     * @param  bool|null $forcerm Always remove intermediate containers, even upon failure. (optional, default to false)
     * @param  int|null $memory Set memory limit for build. (optional)
     * @param  int|null $memswap Total memory (memory + swap). Set as &#x60;-1&#x60; to disable swap. (optional)
     * @param  int|null $cpushares CPU shares (relative weight). (optional)
     * @param  string|null $cpusetcpus CPUs in which to allow execution (e.g., &#x60;0-3&#x60;, &#x60;0,1&#x60;). (optional)
     * @param  int|null $cpuperiod The length of a CPU period in microseconds. (optional)
     * @param  int|null $cpuquota Microseconds of CPU time that the container can get in a CPU period. (optional)
     * @param  string|null $buildargs JSON map of string pairs for build-time variables. Users pass these values at build-time. Docker uses the buildargs as the environment context for commands run via the &#x60;Dockerfile&#x60; RUN instruction, or for variable expansion in other &#x60;Dockerfile&#x60; instructions. This is not meant for passing secret values.  For example, the build arg &#x60;FOO&#x3D;bar&#x60; would become &#x60;{\&quot;FOO\&quot;:\&quot;bar\&quot;}&#x60; in JSON. This would result in the query parameter &#x60;buildargs&#x3D;{\&quot;FOO\&quot;:\&quot;bar\&quot;}&#x60;. Note that &#x60;{\&quot;FOO\&quot;:\&quot;bar\&quot;}&#x60; should be URI component encoded.  [Read more about the buildargs instruction.](https://docs.docker.com/engine/reference/builder/#arg) (optional)
     * @param  int|null $shmsize Size of &#x60;/dev/shm&#x60; in bytes. The size must be greater than 0. If omitted the system uses 64MB. (optional)
     * @param  bool|null $squash Squash the resulting images layers into a single layer. *(Experimental release only.)* (optional)
     * @param  string|null $labels Arbitrary key/value labels to set on the image, as a JSON map of string pairs. (optional)
     * @param  string|null $networkmode Sets the networking mode for the run commands during build. Supported standard values are: &#x60;bridge&#x60;, &#x60;host&#x60;, &#x60;none&#x60;, and &#x60;container:&lt;name|id&gt;&#x60;. Any other value is taken as a custom network&#39;s name or ID to which this container should connect to. (optional)
     * @param  string|null $content_type content_type (optional, default to 'application/x-tar')
     * @param  string|null $x_registry_config This is a base64-encoded JSON object with auth configurations for multiple registries that a build may refer to.  The key is a registry URL, and the value is an auth configuration object, [as described in the authentication section](#section/Authentication). For example:  &#x60;&#x60;&#x60; {   \&quot;docker.example.com\&quot;: {     \&quot;username\&quot;: \&quot;janedoe\&quot;,     \&quot;password\&quot;: \&quot;hunter2\&quot;   },   \&quot;https://index.docker.io/v1/\&quot;: {     \&quot;username\&quot;: \&quot;mobydock\&quot;,     \&quot;password\&quot;: \&quot;conta1n3rize14\&quot;   } } &#x60;&#x60;&#x60;  Only the registry domain name (and port if not the default 443) are required. However, for legacy reasons, the Docker Hub registry must be specified with both a &#x60;https://&#x60; prefix and a &#x60;/v1/&#x60; suffix even though Docker will prefer to use the v2 registry API. (optional)
     * @param  string|null $platform Platform in the format os[/arch[/variant]] (optional)
    ...
    {
        $this->imageBuildWithHttpInfo($dockerfile, $t, $extrahosts, $remote, $q, $nocache, $cachefrom, $pull, $rm, $forcerm, $memory, $memswap, $cpushares, $cpusetcpus, $cpuperiod, $cpuquota, $buildargs, $shmsize, $squash, $labels, $networkmode, $content_type, $x_registry_config, $platform, $target, $outputs, $version, $input_stream, $contentType);
    }
     ...
     * @param  string|null $labels Arbitrary key/value labels to set on the image, as a JSON map of string pairs. (optional)
     * @param  string|null $networkmode Sets the networking mode for the run commands during build. Supported standard values are: &#x60;bridge&#x60;, &#x60;host&#x60;, &#x60;none&#x60;, and &#x60;container:&lt;name|id&gt;&#x60;. Any other value is taken as a custom network&#39;s name or ID to which this container should connect to. (optional)
     * @param  string|null $content_type (optional, default to 'application/x-tar')
     * @param  string|null $x_registry_config This is a base64-encoded JSON object with auth configurations for multiple registries that a build may refer to.  The key is a registry URL, and the value is an auth configuration object, [as described in the authentication section](#section/Authentication). For example:  &#x60;&#x60;&#x60; {   \&quot;docker.example.com\&quot;: {     \&quot;username\&quot;: \&quot;janedoe\&quot;,     \&quot;password\&quot;: \&quot;hunter2\&quot;   },   \&quot;https://index.docker.io/v1/\&quot;: {     \&quot;username\&quot;: \&quot;mobydock\&quot;,     \&quot;password\&quot;: \&quot;conta1n3rize14\&quot;   } } &#x60;&#x60;&#x60;  Only the registry domain name (and port if not the default 443) are required. However, for legacy reasons, the Docker Hub registry must be specified with both a &#x60;https://&#x60; prefix and a &#x60;/v1/&#x60; suffix even though Docker will prefer to use the v2 registry API. (optional)
     * @param  string|null $platform Platform in the format os[/arch[/variant]] (optional)
     * @param  string|null $target Target build stage (optional)
     * @param  string|null $outputs BuildKit output configuration (optional)
    ...
    {
        $request = $this->imageBuildRequest($dockerfile, $t, $extrahosts, $remote, $q, $nocache, $cachefrom, $pull, $rm, $forcerm, $memory, $memswap, $cpushares, $cpusetcpus, $cpuperiod, $cpuquota, $buildargs, $shmsize, $squash, $labels, $networkmode, $content_type, $x_registry_config, $platform, $target, $outputs, $version, $input_stream, $contentType);
    ...
    {
        return $this->imageBuildAsyncWithHttpInfo($dockerfile, $t, $extrahosts, $remote, $q, $nocache, $cachefrom, $pull, $rm, $forcerm, $memory, $memswap, $cpushares, $cpusetcpus, $cpuperiod, $cpuquota, $buildargs, $shmsize, $squash, $labels, $networkmode, $content_type, $x_registry_config, $platform, $target, $outputs, $version, $input_stream, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     *
     * @param  string|null $container The ID or name of the container to commit (optional)
     * @param  string|null $repo Repository name for the created image (optional)
     * @param  string|null $tag Tag name for the create image (optional)
     * @param  string|null $comment Commit message (optional)
     ...
     * Create an image
     *
     * @param  string|null $from_image Name of the image to pull. If the name includes a tag or digest, specific behavior applies:  - If only &#x60;fromImage&#x60; includes a tag, that tag is used. - If both &#x60;fromImage&#x60; and &#x60;tag&#x60; are provided, &#x60;tag&#x60; takes precedence. - If &#x60;fromImage&#x60; includes a digest, the image is pulled by digest, and &#x60;tag&#x60; is ignored. - If neither a tag nor digest is specified, all tags are pulled. (optional)
     * @param  string|null $from_src Source to import. The value may be a URL from which the image can be retrieved or &#x60;-&#x60; to read the image from the request body. This parameter may only be used when importing an image. (optional)
     * @param  string|null $repo Repository name given to an image when it is imported. The repo may include a tag. This parameter may only be used when importing an image. (optional)
     * @param  string|null $tag Tag or digest. If empty when pulling an image, this causes all tags for the given image to be pulled. (optional)
     * @param  string|null $message Set commit message for imported image. (optional)
     * @param  string|null $x_registry_auth A base64url-encoded auth configuration.  Refer to the [authentication section](#section/Authentication) for details. (optional)
     * @param  string[]|null $changes Apply &#x60;Dockerfile&#x60; instructions to the image that is created, for example: &#x60;changes&#x3D;ENV DEBUG&#x3D;true&#x60;. Note that &#x60;ENV DEBUG&#x3D;true&#x60; should be URI component encoded.  Supported &#x60;Dockerfile&#x60; instructions: &#x60;CMD&#x60;|&#x60;ENTRYPOINT&#x60;|&#x60;ENV&#x60;|&#x60;EXPOSE&#x60;|&#x60;ONBUILD&#x60;|&#x60;USER&#x60;|&#x60;VOLUME&#x60;|&#x60;WORKDIR&#x60; (optional)
     ...
     * @param  bool|null $force Remove the image even if it is being used by stopped containers or has other tags (optional, default to false)
     * @param  bool|null $noprune Do not delete untagged parent images (optional, default to false)
    ...
    {
        list($response) = $this->imageDeleteWithHttpInfo($name, $force, $noprune, $platforms, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->imageDeleteRequest($name, $force, $noprune, $platforms, $contentType);
    ...
    {
        return $this->imageDeleteAsyncWithHttpInfo($name, $force, $noprune, $platforms, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        list($response) = $this->imageGetWithHttpInfo($name, $platform, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->imageGetRequest($name, $platform, $contentType);
    ...
    {
        return $this->imageGetAsyncWithHttpInfo($name, $platform, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     *
     * @param  string[]|null $names Image names to filter by (optional)
     * @param  string|null $platform JSON encoded OCI platform describing a platform which will be used to select a platform-specific image to be saved if the image is multi-platform. If not provided, the full multi-platform image will be saved.  Example: &#x60;{\&quot;os\&quot;: \&quot;linux\&quot;, \&quot;architecture\&quot;: \&quot;arm\&quot;, \&quot;variant\&quot;: \&quot;v5\&quot;}&#x60; (optional)
    ...
    {
        list($response) = $this->imageGetAllWithHttpInfo($names, $platform, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->imageGetAllRequest($names, $platform, $contentType);
    ...
    {
        return $this->imageGetAllAsyncWithHttpInfo($names, $platform, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        list($response) = $this->imageHistoryWithHttpInfo($name, $platform, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->imageHistoryRequest($name, $platform, $contentType);
    ...
    {
        return $this->imageHistoryAsyncWithHttpInfo($name, $platform, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        list($response) = $this->imageInspectWithHttpInfo($name, $manifests, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->imageInspectRequest($name, $manifests, $contentType);
    ...
    {
        return $this->imageInspectAsyncWithHttpInfo($name, $manifests, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * List Images
     *
     * @param  bool|null $all Show all images. Only images from a final layer (no children) are shown by default. (optional, default to false)
     * @param  string|null $filters A JSON encoded value of the filters (a &#x60;map[string][]string&#x60;) to process on the images list.  Available filters:  - &#x60;before&#x60;&#x3D;(&#x60;&lt;image-name&gt;[:&lt;tag&gt;]&#x60;,  &#x60;&lt;image id&gt;&#x60; or &#x60;&lt;image@digest&gt;&#x60;) - &#x60;dangling&#x3D;true&#x60; - &#x60;label&#x3D;key&#x60; or &#x60;label&#x3D;\&quot;key&#x3D;value\&quot;&#x60; of an image label - &#x60;reference&#x60;&#x3D;(&#x60;&lt;image-name&gt;[:&lt;tag&gt;]&#x60;) - &#x60;since&#x60;&#x3D;(&#x60;&lt;image-name&gt;[:&lt;tag&gt;]&#x60;,  &#x60;&lt;image id&gt;&#x60; or &#x60;&lt;image@digest&gt;&#x60;) - &#x60;until&#x3D;&lt;timestamp&gt;&#x60; (optional)
     * @param  bool|null $shared_size Compute and show shared size as a &#x60;SharedSize&#x60; field on each image. (optional, default to false)
     * @param  bool|null $digests Show digest information as a &#x60;RepoDigests&#x60; field on each image. (optional, default to false)
     * @param  bool|null $manifests Include &#x60;Manifests&#x60; in the image summary. (optional, default to false)
    ...
    {
        list($response) = $this->imageListWithHttpInfo($all, $filters, $shared_size, $digests, $manifests, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->imageListRequest($all, $filters, $shared_size, $digests, $manifests, $contentType);
    ...
    {
        return $this->imageListAsyncWithHttpInfo($all, $filters, $shared_size, $digests, $manifests, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        $this->imageLoadWithHttpInfo($quiet, $platform, $images_tarball, $contentType);
    }
    ...
    {
        $request = $this->imageLoadRequest($quiet, $platform, $images_tarball, $contentType);
    ...
    {
        return $this->imageLoadAsyncWithHttpInfo($quiet, $platform, $images_tarball, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @param  string|null $tag Tag of the image to push. For example, &#x60;latest&#x60;. If no tag is provided, all tags of the given image that are present in the local image store are pushed. (optional)
    ...
    {
        $this->imagePushWithHttpInfo($name, $x_registry_auth, $tag, $platform, $contentType);
    }
    ...
    {
        $request = $this->imagePushRequest($name, $x_registry_auth, $tag, $platform, $contentType);
    ...
    {
        return $this->imagePushAsyncWithHttpInfo($name, $x_registry_auth, $tag, $platform, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @param  string|null $repo The repository to tag in. For example, &#x60;someuser/someimage&#x60;. (optional)
