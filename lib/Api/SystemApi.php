...
class SystemApi
{
     ...
     * Monitor events
     *
     * @param  string|null $since Show events created since this timestamp then stream new events. (optional)
     * @param  string|null $until Show events created until this timestamp then stop streaming. (optional)
