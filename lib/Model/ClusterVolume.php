...
class ClusterVolume implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The Swarm ID of this volume. Because cluster volumes are Swarm objects, they have an ID, unlike non-cluster volumes. This ID can be used to refer to the Volume instead of the name.
     *
     * @return self
     */
