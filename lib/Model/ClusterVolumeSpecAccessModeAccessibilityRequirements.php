...
class ClusterVolumeSpecAccessModeAccessibilityRequirements implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets requisite
     *
     * @param array[]|null $requisite A list of required topologies, at least one of which the volume must be accessible from.
     *
     * @return self
     */
     ...
     * Sets preferred
     *
     * @param array[]|null $preferred A list of topologies that the volume should attempt to be provisioned in.
     *
     * @return self
     */
