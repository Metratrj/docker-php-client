...
class ClusterVolumeSpecAccessModeCapacityRange implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets required_bytes
     *
     * @param int|null $required_bytes The volume must be at least this big. The value of 0 indicates an unspecified minimum
     *
     * @return self
     */
     ...
     * Sets limit_bytes
     *
     * @param int|null $limit_bytes The volume must not be bigger than this. The value of 0 indicates an unspecified maximum.
     *
     * @return self
     */
