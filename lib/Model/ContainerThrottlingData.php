 ...
 *
 * @category Class
 * @description CPU throttling stats of the container.  This type is Linux-specific and omitted for Windows containers.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class ContainerThrottlingData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContainerThrottlingData';
    ...
    protected static array $openAPINullables = [
        'periods' => false,
        'throttled_periods' => false,
        'throttled_time' => false
    ];
    ...
    protected static $setters = [
        'periods' => 'setPeriods',
        'throttled_periods' => 'setThrottledPeriods',
        'throttled_time' => 'setThrottledTime'
    ];
    ...
    protected static $getters = [
        'periods' => 'getPeriods',
        'throttled_periods' => 'getThrottledPeriods',
        'throttled_time' => 'getThrottledTime'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('throttled_periods', $data ?? [], null);
        $this->setIfExists('throttled_time', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets periods
     *
     * @param int|null $periods Number of periods with throttling active.
     *
     * @return self
     */
    ...
    /**
     * Gets throttled_periods
     *
     * @return int|null
     */
    public function getThrottledPeriods()
    {
        return $this->container['throttled_periods'];
    }

    /**
     * Sets throttled_periods
     *
     * @param int|null $throttled_periods Number of periods when the container hit its throttling limit.
     *
     * @return self
     */
    ...
    {
        return $this->container['throttled_time'];
    }

    /**
     * Sets throttled_time
     *
     * @param int|null $throttled_time Aggregated time (in nanoseconds) the container was throttled for.
     *
     * @return self
     */
