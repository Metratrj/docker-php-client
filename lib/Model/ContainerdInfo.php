 ...
 *
 * @category Class
 * @description Information for connecting to the containerd instance that is used by the daemon. This is included for debugging purposes only.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class ContainerdInfo implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContainerdInfo';
    ...
    protected static $openAPITypes = [
        'address' => 'string',
        'namespaces' => '\OpenAPI\Client\Model\ContainerdInfoNamespaces'
    ];
    ...
    */
     ...
     * Sets address
     *
     * @param string|null $address The address of the containerd socket.
     *
     * @return self
     */
