...
class CreateImageInfo implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets error
     *
     * @param string|null $error errors encountered during the operation.   > **Deprecated**: This field is deprecated since API v1.4, and will be omitted in a future API version. Use the information in errorDetail instead.
     *
     * @return self
     */
     ...
     * Sets progress
     *
     * @param string|null $progress Progress is a pre-formatted presentation of progressDetail.   > **Deprecated**: This field is deprecated since API v1.8, and will be omitted in a future API version. Use the information in progressDetail instead.
     *
     * @return self
     */
