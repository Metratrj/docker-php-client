...
class DeviceInfo implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets source
     *
     * @param string|null $source The origin device driver.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier for the device within its source driver. For CDI devices, this would be an FQDN like \"vendor.com/gpu=0\".
     *
     * @return self
     */
