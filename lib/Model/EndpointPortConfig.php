...
class EndpointPortConfig implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets target_port
     *
     * @param int|null $target_port The port inside the container.
     *
     * @return self
     */
     ...
     * Sets published_port
     *
     * @param int|null $published_port The port on the swarm hosts.
     *
     * @return self
     */
     ...
     * Sets publish_mode
     *
     * @param string|null $publish_mode The mode in which port is published.  <p><br /></p>  - \"ingress\" makes the target port accessible on every node,   regardless of whether there is a task for the service running on   that node or not. - \"host\" bypasses the routing mesh and publish the port directly on   the swarm node where that service is running.
     *
     * @return self
     */
