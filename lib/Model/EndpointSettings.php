...
class EndpointSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('gw_priority', $data ?? [], null);
    ...
    */
    ...
    public function setIpamConfig($ipam_config)
    {
        if (is_null($ipam_config)) {
            ...
            $index = array_search('ipam_config', $nullablesSetToNull, true);
            if ($index !== false) {
    ...
    public function setDriverOpts($driver_opts)
    {
        if (is_null($driver_opts)) {
            ...
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('driver_opts', $nullablesSetToNull, true);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
