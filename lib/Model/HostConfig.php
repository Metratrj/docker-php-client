...
class HostConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets sysctls
     *
     * @param array<string,string>|null $sysctls A list of kernel parameters (sysctls) to set in the container.  This field is omitted if not set.
     *
     * @return self
     */
    ...
    {
        if (is_null($sysctls)) {
            array_push($this->openAPINullablesSetToNull, 'sysctls');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('sysctls', $nullablesSetToNull, true);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setRuntime($runtime)
    {
        if (is_null($runtime)) {
            ...
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('runtime', $nullablesSetToNull, true);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
