...
class ImageInspect implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'manifests' => '\OpenAPI\Client\Model\ImageManifestSummary[]',
        'repo_tags' => 'string[]',
        'repo_digests' => 'string[]',
        'parent' => 'string',
        'comment' => 'string',
        ...
        'author' => 'string',
        'config' => '\OpenAPI\Client\Model\ImageConfig',
        'architecture' => 'string',
        'variant' => 'string',
        'os' => 'string',
        'os_version' => 'string',
    ...
    */
     ...
     * Sets created
     *
     * @param string|null $created Date and time at which the image was created, formatted in [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) format with nano-seconds.  This information is only available if present in the image, and omitted otherwise.
     *
     * @return self
     */
