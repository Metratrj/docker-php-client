...
class ImageManifestSummaryAttestationData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImageManifestSummary_AttestationData';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['for'] === null) {
            $invalidProperties[] = "'for' can't be null";
        }
     ...
     * Sets for
     *
     * @param string $for The digest of the image manifest that this attestation is for.
     *
     * @return self
     */
