...
class ImageSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets containers
     *
     * @param int $containers Number of containers using this image. Includes both stopped and running containers.  `-1` indicates that the value has not been set / calculated.
     *
     * @return self
     */
