...
/**
 * MountImageOptions Class Doc Comment
 *
 * @category Class
 ...
 */
class MountImageOptions implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Mount_ImageOptions';
    ...
    {
        $this->setIfExists('subpath', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets subpath
     *
     * @param string|null $subpath Source path inside the image. Must be relative without any back traversals.
     *
     * @return self
     */
