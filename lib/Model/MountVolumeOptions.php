...
class MountVolumeOptions implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets no_copy
     *
     * @param bool|null $no_copy Populate volume with data from the target.
     *
     * @return self
     */
     ...
     * Sets subpath
     *
     * @param string|null $subpath Source path inside the volume. Must be relative without any back traversals.
     *
     * @return self
     */
