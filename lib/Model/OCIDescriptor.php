...
class OCIDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'data' => 'string',
        'platform' => '\OpenAPI\Client\Model\OCIPlatform',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('artifact_type', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets media_type
     *
     * @param string|null $media_type The media type of the object this schema refers to.
     *
     * @return self
     */
     ...
     * Sets digest
     *
     * @param string|null $digest The digest of the targeted content.
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param int|null $size The size in bytes of the blob.
     *
     * @return self
     */
     ...
     * Sets urls
     *
     * @param string[]|null $urls List of URLs from which this object MAY be downloaded.
     *
     * @return self
     */
     ...
     * Sets annotations
     *
     * @param array<string,string>|null $annotations Arbitrary metadata relating to the targeted content.
     *
     * @return self
     */
     ...
     * Sets data
     *
     * @param string|null $data Data is an embedding of the targeted content. This is encoded as a base64 string when marshalled to JSON (automatically, by encoding/json). If present, Data can be used directly to avoid fetching the targeted content.
     *
     * @return self
     */
    ...
    {
        return $this->container['artifact_type'];
    }

    /**
     * Sets artifact_type
     *
     * @param string|null $artifact_type ArtifactType is the IANA media type of this artifact.
     *
     * @return self
     */
    public function setArtifactType($artifact_type)
    {
        if (is_null($artifact_type)) {
        ...
        $this->container['artifact_type'] = $artifact_type;
