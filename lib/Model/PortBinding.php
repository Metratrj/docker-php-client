...
class PortBinding implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets host_ip
     *
     * @param string|null $host_ip Host IP address that the container's port is mapped to.
     *
     * @return self
     */
     ...
     * Sets host_port
     *
     * @param string|null $host_port Host port number that the container's port is mapped to.
     *
     * @return self
     */
