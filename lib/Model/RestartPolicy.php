...
class RestartPolicy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name - Empty string means not to restart - `no` Do not automatically restart - `always` Always restart - `unless-stopped` Restart always except when the user has manually stopped the container - `on-failure` Restart only when the container exit code is non-zero
     *
     * @return self
     */
     ...
     *
     * @param int|null $maximum_retry_count If `on-failure` is used, the number of times to retry before giving up.
     *
     * @return self
     */
