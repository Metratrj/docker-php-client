...
class ServiceSpecRollbackConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets failure_action
     *
     * @param string|null $failure_action Action to take if an rolled back task fails to run, or stops running during the rollback.
     *
     * @return self
     */
     ...
     *
     * @param float|null $max_failure_ratio The fraction of tasks that may fail during a rollback before the failure action is invoked, specified as a floating point number between 0 and 1.
     *
     * @return self
     */
