...
class SwarmSpecCAConfigExternalCAsInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets options
     *
     * @param array<string,string>|null $options An object with key/value pairs that are interpreted as protocol-specific options for the external CA driver.
     *
     * @return self
     */
     ...
     * Sets ca_cert
     *
     * @param string|null $ca_cert The root CA certificate (in PEM format) this external CA uses to issue TLS certificates (assumed to be to the current swarm root CA certificate if not provided).
     *
     * @return self
     */
