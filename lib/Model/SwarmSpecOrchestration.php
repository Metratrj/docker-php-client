...
class SwarmSpecOrchestration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param int|null $task_history_retention_limit The number of historic tasks to keep per instance or node. If negative, never remove completed or failed tasks.
     *
     * @return self
     */
