...
class SystemInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'firewall_backend' => '\OpenAPI\Client\Model\FirewallInfo',
        'discovered_devices' => '\OpenAPI\Client\Model\DeviceInfo[]',
        'warnings' => 'string[]',
        'cdi_spec_dirs' => 'string[]',
        'containerd' => '\OpenAPI\Client\Model\ContainerdInfo'
    ];
    ...
    protected static $setters = [
        ...
        'firewall_backend' => 'setFirewallBackend',
        'discovered_devices' => 'setDiscoveredDevices',
    ...
    protected static $getters = [
        ...
        'firewall_backend' => 'getFirewallBackend',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('firewall_backend', $data ?? [], null);
        $this->setIfExists('discovered_devices', $data ?? [], null);
        $this->setIfExists('warnings', $data ?? [], null);
        $this->setIfExists('cdi_spec_dirs', $data ?? [], null);
        $this->setIfExists('containerd', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param bool|null $bridge_nf_iptables Indicates if `bridge-nf-call-iptables` is available on the host when the daemon was started.  <p><br /></p>  > **Deprecated**: netfilter module is now loaded on-demand and no longer > during daemon startup, making this field obsolete. This field is always > `false` and will be removed in a API v1.49.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $bridge_nf_ip6tables Indicates if `bridge-nf-call-ip6tables` is available on the host.  <p><br /></p>  > **Deprecated**: netfilter module is now loaded on-demand, and no longer > during daemon startup, making this field obsolete. This field is always > `false` and will be removed in a API v1.49.
     *
     * @return self
     */
     ...
     *
     * @param string|null $operating_system Name of the host's operating system, for example: \"Ubuntu 24.04 LTS\" or \"Windows Server 2016 Datacenter\"
     *
     * @return self
     */
    ...
    public function setRegistryConfig($registry_config)
    {
        if (is_null($registry_config)) {
            ...
            $index = array_search('registry_config', $nullablesSetToNull, true);
            if ($index !== false) {
    ...
    {
        return $this->container['firewall_backend'];
    }
     ...
     * @return self
     */
    public function setFirewallBackend($firewall_backend)
    {
        if (is_null($firewall_backend)) {
            array_push($this->openAPINullablesSetToNull, 'firewall_backend');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('firewall_backend', $nullablesSetToNull, true);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['firewall_backend'] = $firewall_backend;
    ...
    {
        return $this->container['discovered_devices'];
    }
    ...
    {
        if (is_null($containerd)) {
            array_push($this->openAPINullablesSetToNull, 'containerd');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('containerd', $nullablesSetToNull, true);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
