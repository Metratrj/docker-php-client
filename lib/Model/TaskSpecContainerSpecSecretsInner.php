...
class TaskSpecContainerSpecSecretsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets secret_id
     *
     * @param string|null $secret_id SecretID represents the ID of the specific secret that we're referencing.
     *
     * @return self
     */
     ...
     * Sets secret_name
     *
     * @param string|null $secret_name SecretName is the name of the secret that this references, but this is just provided for lookup/display purposes. The secret in the reference will be identified by its ID.
     *
     * @return self
     */
